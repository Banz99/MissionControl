...
namespace ams::controller {
    ...
    class NSOProController : public SwitchController {

        public:
            NSOProController(const bluetooth::Address *address, HardwareID id);
            virtual ~NSOProController() {};
        ...
        private:
            ...
            uint8_t m_n64_calibrated_zero[3];
